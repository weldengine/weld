...
const ecs_root_surface = [_][]const u8{
    ...
    "StorageKind",               "TypeKind",          "ArchetypeId",
    "Tick",                      "Transform",         "Velocity",
    "Archetype",                 "Chunk",             "Location",
    "WorldError",                "Query",             "With",
    "Without",                   "Predicate",         "Changed",
    "CommandBuffer",             "Command",           "ObserverFn",
    "SystemScheduler",           "SystemDescriptor",  "Phase",
    "FrameContext",              "SystemContext",     "SystemFn",
    "Reads",                     "Writes",            "ReadsResource",
    "WritesResource",            "AccessDescriptor",  "AccessKind",
    "JobBuilder",                "RegistrationError", "view",
    "View",                      "Access",            "SystemContextOf",
