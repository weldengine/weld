...
- [ ] `engine-phase-0-plan.md` (M0.1 section) — read <YYYY-MM-DD HH:MM>
- [ ] `engine-ecs-internals.md` (sections 1, 3, 4, 5, 6, 7, 8, 12) — read <YYYY-MM-DD HH:MM>
- [ ] `engine-tier-interfaces.md` — read <YYYY-MM-DD HH:MM>
- [ ] `engine-phase-0-criteria.md` (C0.1 + Reference machine) — read <YYYY-MM-DD HH:MM>
- [ ] `engine-zig-conventions.md` (§13, §16, §19) — read <YYYY-MM-DD HH:MM>
- [ ] `engine-development-workflow.md` (§2, §3, §3.6, §4) — read <YYYY-MM-DD HH:MM>
