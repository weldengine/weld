//! Queue Vulkan.
//!
//! A single queue (graphics + compute + transfer + present
...
//!
//! Dedicated compute/transfer queues would follow if the corresponding queue
...
/// Retrieves the Vulkan queue associated with the requested type:
