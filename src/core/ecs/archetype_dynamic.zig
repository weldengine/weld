//! DEPRECATED re-exports of `archetype.zig` and `chunk.zig`, kept so callers
//! of the old `DynamicArchetype` name still compile. New code imports the
//! canonical names; this file retires once every caller is migrated.
