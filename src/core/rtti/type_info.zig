//! RTTI type metadata — public surface of the reflection runtime.
//!
...
//! loader.
//!
//! The IPC schema-hash swap, the resource store and the event bus all land on top of
//! this file without changing its public surface.
//!
//! See `ARCH-007`.
...
/// exercised by the registry test — runtime consumers never reach
...
//
// These exist so the comptime builder can map a user-defined struct
...
// using raw `[N]f32 align(16)` arrays — they are untouched
// here (no consumer wiring).
